...
database.createAudit = async function createAudit(auditType, fieldName, oldValue, newValue, key, note, userName){
    try{
      ...
      VALUES('${auditType}', '${key}', '${userName}', 'GETDATE()', '${fieldName}', '${oldValue}', '${newValue}', '${note}')
      `)
